...
class CommonCurrencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $common_currency = [
            ...
            ["symbol" => "Br", "name" => "Belarusian Ruble", "symbol_native" => "руб.", "decimal_digits" => 2, "rounding" => 0, "code" => "BYN", "name_plural" => "Belarusian rubles"],
            ...
            ["symbol" => "L.L.", "name" => "Lebanese Pound", "symbol_native" => "ل.ل.‏", "decimal_digits" => 0, "rounding" => 0, "code" => "LBP", "name_plural" => "Lebanese pounds"],
            ...
            ["symbol" => "RUB", "name" => "Russian Ruble", "symbol_native" => "₽.", "decimal_digits" => 2, "rounding" => 0, "code" => "RUB", "name_plural" => "Russian rubles"],
            ...
            ["symbol" => "ZWL$", "name" => "Zimbabwean Dollar", "symbol_native" => "ZWL$", "decimal_digits" => 0, "rounding" => 0, "code" => "ZWL", "name_plural" => "Zimbabwean Dollar"],
        ];

        CommonCurrency::insert($common_currency);
    }
}
